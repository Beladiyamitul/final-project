                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <NavLink exact className="nav-link dropdown-toggle" to={"/"} data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <span className="nav-label">Pages <span className="caret" /></span></NavLink>
                            ...
                            <li>
                                ...
                                <NavLink exact to={"/testimonial"}>Testimonial</NavLink>
